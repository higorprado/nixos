...
for script_rel in "${scripts[@]}"; do
  ...
  audit_check_script_dependencies "$script_rel" "$base" "$RAW_DIR" run_capture note_finding script_incons notes
  audit_apply_policy_checks "$script_rel" "$script_path" "$base" "$RAW_DIR" note_finding script_incons notes
